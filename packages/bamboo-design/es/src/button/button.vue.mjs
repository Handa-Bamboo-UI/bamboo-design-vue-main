import { defineComponent as p, computed as u, resolveComponent as k, createElementBlock as l, openBlock as t, normalizeClass as i, createBlock as b, createCommentVNode as n, renderSlot as r, createTextVNode as y, createVNode as v, Transition as h, withCtx as _ } from "vue";
    ...
    return (s, a) => {
      ...
      return t(), l("div", {
        ...
        e.type === "link" ? (t(), l("div", {
          ...
          onClick: f,
          href: e.href,
          class: i(["bm-button custom-link", c.value])
        }, [
